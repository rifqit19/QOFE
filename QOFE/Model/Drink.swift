...
let drinkData = [
    ...
    //HOT
    Drink(id: UUID().uuidString, name: "Espresso2", imageName: "espresso", category: Category.hot, description: "Espresso is the purest distillation of the coffee bean. It doesn’t refer to a bean or blend, but actually the preparation method.", price: 2.50),
